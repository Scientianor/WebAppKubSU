                    ...
                    <>
                        ...
                        {weatherData && (
                            <div className="container">
                                ...
                                <span>Температура: {(weatherData.main.temp - 273.15).toFixed(1)}°C</span>
                                <span>Ветер: {weatherData.wind.speed} м/с</span>
                                <span>Осадки: {weatherData.clouds.all}%</span>
                            </div>
                        )}
                    </>
                )}
